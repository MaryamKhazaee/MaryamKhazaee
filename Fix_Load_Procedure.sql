...
-- =============================================
-- Description: Loads Salary data (Auto-handling schema mismatches between SnapMarket and Zooket)
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        PRINT 'Starting Salary Data Load (Schema-Mismatch Tolerant Mode)...';
        ...
        -- 4. Dynamic Insert for Common Columns
        ...
        PRINT 'Common columns mapping: ' + LEFT(@CommonCols, 100) + '...';
